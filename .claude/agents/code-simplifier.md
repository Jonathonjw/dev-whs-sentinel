...
description: Simplifies code for clarity, consistency, and maintainability while preserving all functionality. Use this agent after completing a coding task or writing a logical chunk of code to refine and polish the implementation.
model: opus
color: blue
memory: user
---
